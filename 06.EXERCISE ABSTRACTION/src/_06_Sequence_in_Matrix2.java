...
public class _06_Sequence_in_Matrix2 { // 100/100
    public static void main(String[] args) {
        ...
        printMatrix(matrix[maxRow][maxCol], maxSequence);
    }

    private static void printMatrix(String maxString1, int maxSequence) {

        for (int i = 1; i < maxSequence; i++) {
            System.out.print(maxString1 + ", ");
        }
        System.out.print(maxString1);
    }
